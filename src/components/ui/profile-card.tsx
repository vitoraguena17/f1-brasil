            ...
            <div className="w-full md:w-[45%] bg-white/70 backdrop-blur-xl p-6 sm:p-8 lg:p-12 rounded-3xl border border-zinc-200 group card-content shadow-[0_20px_40px_rgba(0,0,0,0.30)] md:order-2 flex flex-col justify-center">
                ...
                <div className="card-reveal flex gap-4 lg:gap-6 mt-8 md:mt-10 w-full">
                    <div className="flex-1 bg-white/80 backdrop-blur-md px-2 py-4 lg:py-6 rounded-2xl border border-zinc-200 shadow-sm flex flex-col items-center justify-center transition-colors hover:border-green-400/50">
                        <span className="block text-3xl sm:text-4xl lg:text-5xl font-bold text-zinc-900">{titles}</span>
                        <span className="text-[9px] lg:text-[10px] uppercase tracking-widest text-zinc-500 mt-1 text-center">{titlesLabel}</span>
                    </div>
                    <div className="flex-1 bg-white/80 backdrop-blur-md px-2 py-4 lg:py-6 rounded-2xl border border-zinc-200 shadow-sm flex flex-col items-center justify-center transition-colors hover:border-green-400/50">
                        <span className="block text-3xl sm:text-4xl lg:text-5xl font-bold text-zinc-900">{wins}</span>
